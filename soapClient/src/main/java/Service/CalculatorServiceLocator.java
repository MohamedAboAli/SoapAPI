...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements Service.CalculatorService {
    ...
    private java.lang.String CalculatorPort_address = "http://localhost:8089/cal";
    ...
    public Service.Calculator getCalculatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Service.CalculatorPortBindingStub _stub = new Service.CalculatorPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Service.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                Service.CalculatorPortBindingStub _stub = new Service.CalculatorPortBindingStub(new java.net.URL(CalculatorPort_address), this);
                _stub.setPortName(getCalculatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Service/", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Service/", "CalculatorPort"));
        }
